...
<title>Google Cloud Migration System</title>
<style>
body  {
...
<body>
<br><br><br>
<!--   <h1>Google Cloud MIGRATION System</h1> -->
   <hr />

   <form:form action="googlecon" method="post" modelAttribute="user">
      <table>
               <tr>
            <td>Google VM Name</td>
            <td><form:input path="gcloud_raw_name" /></td>
         </tr>
         <tr>
         	<td>VM Name</td>
         	<br><br>
