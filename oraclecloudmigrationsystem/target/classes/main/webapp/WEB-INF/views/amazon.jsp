...
<body>
<br><br><br>
<!-- <h1>Amazon Cloud MIGRATION System</h1>  -->   
   <hr />

   <form:form action="amazoncon" method="post" modelAttribute="user">
      <table>
         <tr>
            <td>AWS Instance ID:</td>
            <td><form:input path="aws_instance_id" /></td>
         </tr>
            <tr>
            <td>AWS Bucket Name:</td>
            <td><form:password path="aws_bucket" /></td>
         </tr>
         <tr>
            <td> AWS Export Prefix : </td>
            <td><form:input path="aws_prefix" /></td>
         </tr>
         <tr>
         <br><br>
